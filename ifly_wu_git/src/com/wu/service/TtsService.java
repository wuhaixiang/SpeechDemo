...
public class TtsService {
   ...
   private	ApkInstaller mInstaller ;
	...
	public TtsService(Context context,ApkInstaller apkInstaller) {
		...
		mSharedPreferences =context.getSharedPreferences(TtsSettings.PREFER_NAME,this_Context.MODE_PRIVATE);
...
//		int code = mTts.synthesizeToUri(text, path, mTtsListener);
	...
	private SynthesizerListener mTtsListener = new SynthesizerListener() {
		...
		public void onBufferProgress(int percent, int beginPos, int endPos,
			...
			showTip(String.format(this_Context.getString(R.string.tts_toast_format),
